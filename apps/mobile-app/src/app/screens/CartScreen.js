              ...
              return (
                ...
                >
                  <View style={{ flexDirection: 'row' }}>
                    ...
                    <Text style={{ fontSize: 25, fontWeight: '700', flex: 2 }}>
                      £99.99
                    </Text>
                  </View>
                  <View
    ...
    >
          ...
          return (
            <View
              style={{
                ...
                marginHorizontal: 20,
                margin: 10,
                backgroundColor: colours.TailWindColors['mineral-green'][100],
            ...
            >
              ...
              <View style={{ flex: 3, marginLeft: 5 }}>
                ...
                >
                  <View>
                    <Text
                      style={{ color: colours.LogoColours.green, fontSize: 18 }}
                    >
                      x{item.quantity}
                    </Text>
                  </View>
                  <View>
                    ...
                    >
                      £{item.total.toString().slice(0, -2)}.
                      {item.total.toString().slice(-2)}
                    </Text>
                  </View>
                </View>
              </View>
      ...
      >
        ...
        >
          ...
          >
            Pay via Card - £{cartTotal.toString().slice(0, -2)}.
            {cartTotal.toString().slice(-2)}
          </Text>
        </TouchableOpacity>
      </View>
      <View
