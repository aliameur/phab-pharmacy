  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1, marginLeft: 20, marginTop: 20 }}>
        <Text style={{ color: colours.LogoColours.cream, fontSize: 30 }}>
          {data.title}
        </Text>
      </View>
      <View
      ...
      <View
        style={{ flex: 2, alignSelf: 'center', justifyContent: 'flex-start' }}
      >
        ...
        >
          <Text
            style={{
              fontWeight: '700',
              fontSize: 20,
              color: colours.TailWindColors.pampas[900],
            }}
          >
            Price:{' '}
          </Text>
          <Text
            style={{ fontSize: 20, color: colours.TailWindColors.pampas[900] }}
          >
            £{data.price.toString().slice(0, 2)}.
            {data.price.toString().slice(2, 4)}
          </Text>
        </View>
      </View>
