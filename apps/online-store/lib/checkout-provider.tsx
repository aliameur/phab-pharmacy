...
import { ToggleStateType, useToggleState } from './hooks';
...
interface CheckoutContext {
  ...
  sameAsBilling: ToggleStateType;
  editAddresses: ToggleStateType;
  editShipping: ToggleStateType;
  editPayment: ToggleStateType;
  isCompleting: ToggleStateType;
      ...
      >
        {isLoading && cart?.id === '' ? (
          ...
          <Elements
            ...
            stripe={loadStripe(env.NEXT_PUBLIC_STRIPE_KEY)}
          >{children}</Elements>
        )}
      </CheckoutContext.Provider>
    </FormProvider>
