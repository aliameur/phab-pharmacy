...
describe('getProducts', () => {
  ...
  it('fetches products successfully', async () => {
    mockRequestFn.mockResolvedValue({ body: { products: mockProducts } });

    const result = await getProducts(mockRequestFn)();
  ...
  it('handles errors', async () => {
    ...
    await expect(getProducts(mockRequestFn)()).rejects.toThrow('Network error');
  });
});
